...
from src.workflows.train_tune.bert_eval.custom_types import BertEvalRequest
...
async def main() -> None:
    ...
    request = BertEvalRequest(
        run_id="bert-checkpointed-019b47f8-72d3-767c-87d9-15c14d9cdb99",
        dataset_name="glue",
