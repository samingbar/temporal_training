"""Tests for BERT fine-tuning and evaluation activities (bert_parallel package)."""
...
class TestBertParallelActivities:
    """Test suite for BERT parallel fine-tune and eval activities."""
    ...
    async def test_fine_tune_bert_delegates_to_sync(self) -> None:
        ...
        with patch(
            "src.workflows.train_tune.bert_parallel.bert_activities.BertFineTuneActivities._fine_tune_bert_sync",
    ...
    async def test_evaluate_bert_model_delegates_to_sync(self) -> None:
        ...
        with patch(
            "src.workflows.train_tune.bert_parallel.bert_activities.BertEvalActivities._evaluate_bert_model_sync",
            return_value=expected_result,
        ) as mock_sync:
